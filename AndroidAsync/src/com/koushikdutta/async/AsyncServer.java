...
public class AsyncServer {
	...
	private ConnectFuture connectResolvedInetSocketAddress(final InetSocketAddress address,
	...
	public Cancellable connectSocket(final InetSocketAddress remote, final ConnectCallback callback) {
		...
		return new TransformFuture<AsyncSocket, InetAddress>() {
			...
			protected void transform(InetAddress result) throws Exception {
				setParent(connectResolvedInetSocketAddress(
	...
	ExecutorService synchronousWorkers = Executors.newFixedThreadPool(5);
	...
	private static void runLoop(AsyncServer server, Selector selector, LinkedList<Scheduled> queue, boolean keepRunning)
			throws IOException {
